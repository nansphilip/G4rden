    ...
    <div class="pt-2 flex flex-column gap-2">
        <div class="rounded-box" post="">
            ...
            <form id="username-edit" class="flex flex-row justify-between gap-2">
                <input type="text" id="username-input" data-id="<?= $user->id; ?>" class="input-form" value="<?= $user->username; ?>">
                <button type="submit" class="submit-button" name="updateUsername">Mettre à jour</button>
            </form>
        </div>
        <div class="rounded-box" post="">
            <h3 class="pb-1">Firstname</h3>
            <form id="firstname-edit" class="flex flex-row justify-between gap-2">
                <input type="text" id="firstname-input" data-id="<?= $user->id; ?>" class="input-form" value="<?= $user->firstname; ?>">
                <button type="submit" class="submit-button" name="updateFirstname">Mettre à jour</button>
            </form>
        </div>
        <div class="rounded-box" post="">
            <h3 class="pb-1">Lastname</h3>
            <form id="lastname-edit" class="flex flex-row justify-between gap-2">
                <input type="text" id="lastname-input" data-id="<?= $user->id; ?>" class="input-form" value="<?= $user->lastname; ?>">
                <button type="submit" class="submit-button" name="updateLastname">Mettre à jour</button>
            </form>
        </div>
    </div>
</main>
